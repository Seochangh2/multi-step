...
Consider naming this operation or using "graphql.operation()" request handler to intercept GraphQL requests regardless of their operation name/type. Read more: https://mswjs.io/docs/api/graphql/operation`);
  ...
  extendResolverArgs(args) {
    var _a2, _b2, _c;
    return {
      query: ((_a2 = args.parsedResult) == null ? void 0 : _a2.query) || "",
  ...
  log(args) {
    return __async7(this, null, function* () {
      ...
      const loggedResponse = yield serializeResponse(args.response);
      const statusColor = getStatusCodeColor(loggedResponse.status);
      const requestInfo = ((_a2 = args.parsedResult) == null ? void 0 : _a2.operationName) ? `${(_b2 = args.parsedResult) == null ? void 0 : _b2.operationType} ${(_c = args.parsedResult) == null ? void 0 : _c.operationName}` : `anonymous ${(_d = args.parsedResult) == null ? void 0 : _d.operationType}`;
      console.groupCollapsed(
...
var getResponse = (request, handlers, resolutionContext) => __async8(void 0, null, function* () {
...
@bundled-es-modules/cookie/index-esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-6Y7RZWBE.js.map
